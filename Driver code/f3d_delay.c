...
/// Not a perfect delay function by any means, since it operates entirely off of how fast the CPU runs
/// but it was the implementation given, and given more time I would have found a better solution
