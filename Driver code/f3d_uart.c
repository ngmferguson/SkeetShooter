...
****************************/ 
//Authors: Nathaniel Ferguson and Alexander Kenney
...
/// Initializes our pins on our board
...
//sends a character to our program
int putchar(int c) {
...
//gets a series of characters from serialT
int getchar(void) {
  int r;
  while((r = dequeue(&rxbuf))==0);
  return r;
}

// gets a single character from our serialT UNIX input
